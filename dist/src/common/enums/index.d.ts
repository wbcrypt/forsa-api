...
export declare enum FinancingLevel {
    LEVEL1 = "level1",
    LEVEL2 = "level2",
    LEVEL3 = "level3"
}
export declare enum DecisionResult {
    APPROVED_LEVEL1 = "approved_level1",
    APPROVED_LEVEL2 = "approved_level2",
    APPROVED_LEVEL3 = "approved_level3",
    REJECTED = "rejected",
...
export declare enum ScoreDimension {
...
export declare enum ScoreSeverity {
    STANDARD = "standard",
    ELEVATED = "elevated",
    SEVERE = "severe"
}
export declare enum ScoreBand {
    HIGH_RISK = "high_risk",
...
export declare enum SourceTrustLevel {
...
export declare enum UniversityStatus {
    PROSPECT = "prospect",
    CONTACT = "contact",
...
export declare enum ExceptionalEventType {
...
export declare enum ApprovalSequencing {
