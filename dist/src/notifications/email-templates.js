...
<head>
  ...
  <title>FORSA</title>
  <style>${exports.FORSA_EMAIL_STYLES}</style>
</head>
<body>
  <div class="wrapper">
    <div class="header">
...
`;
const applicationReceivedEmail = (data) => ({
...
const aiInterviewCompletedEmail = (data) => ({
...
exports.preApprovedEmail = preApprovedEmail;
const activationMeetingEmail = (data) => ({
...
exports.activationMeetingEmail = activationMeetingEmail;
...
const paymentReceivedEmail = (data) => ({
...
exports.bronzeMemberEmail = bronzeMemberEmail;
exports.EMAIL_TEMPLATES = {
    APPLICATION_RECEIVED: exports.applicationReceivedEmail,
    AI_INTERVIEW_COMPLETED: exports.aiInterviewCompletedEmail,
    PRE_APPROVED: exports.preApprovedEmail,
    ACTIVATION_MEETING: exports.activationMeetingEmail,
    PAYMENT_REMINDER: exports.paymentReminderEmail,
    PAYMENT_RECEIVED: exports.paymentReceivedEmail,
    BRONZE_MEMBER: exports.bronzeMemberEmail,
};
const GUARANTOR_INVITED = (guarantorName, studentName, activationLink) => ({
...
exports.GUARANTOR_INVITED = GUARANTOR_INVITED;
const GUARANTOR_PAYMENT_REMINDER = (guarantorName, studentName, amount, dueDate, paymentUrl) => ({
...
exports.GUARANTOR_PAYMENT_REMINDER = GUARANTOR_PAYMENT_REMINDER;
const GUARANTOR_PAYMENT_CONFIRMED = (guarantorName, studentName, amount, month) => ({
...
exports.GUARANTOR_PAYMENT_CONFIRMED = GUARANTOR_PAYMENT_CONFIRMED;
